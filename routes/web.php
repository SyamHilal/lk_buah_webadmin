...
Route::group(['middleware' => ['auth','checkRole:admin']],function(){    
    ...
    Route::get('pengaturan/updateuser','admin\PengaturanController@updateuser')->name('admin.pengaturan.updateuser');
    Route::post('pengaturan/simpanuser','admin\PengaturanController@simpanuser')->name('admin.pengaturan.simpanuser');
    ...
    Route::get('/admin/transaksi/cetakAll','admin\TransaksiController@cetakAll')->name('admin.transaksi.cetakAll');
