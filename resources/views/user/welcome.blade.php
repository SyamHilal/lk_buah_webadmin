...
<div class="site-blocks-cover" data-aos="fade">
    <div class="container">
    <div class="row align-items-center align-items-md-center justify-content-end">
        <div class="col-md-12 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Cari Olahan Mangga Kesukaanmu Disini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Berbagai olahan mangga disini merupakan hasil daru buah mangga terbaik yang ada di Indramayu. </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas produk terjamin karena semuanya terbuat dari buah mangga pilihan.</p>
        </div>
        </div>
