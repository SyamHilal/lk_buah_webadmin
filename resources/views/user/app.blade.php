...
<html lang="en">
  <head>
    <title>Woi Pelem &mdash; Toko Olahan Buah Mangga </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">Mang Pelem Blih?</a>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jalan sesat menuju neraka jahanam paling dalam</li>
                <li class="phone"><a href="#">Hubungi Bang Diyanto Admin Trevel Neraka</a></li>
                <li class="email">mangga-montok@gmail.com</li>
              </ul>
            </div>
