                  ...
                  <div class="card-body">
                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                          <td>Tanggal Pesanan Sampai</td>
                          <td>:</td>
                          <td  class="p-2">{{ $order->updated_at }}</td>
                          @endif
                      </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Total Bayar</td>
                          <td>:</td>
                          <td  class="p-2">Rp. {{ number_format($order->subtotal+$order->ongkir,2,',','.') }} ( Sudah Termasuk Ongkir )</td>
                      </tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td  class="p-2">{{ $order->detail_alamat.' '.$order->type.' '.$order->city_name.' - Provisi '.$order->province_name }}</td>
                        </tr>
